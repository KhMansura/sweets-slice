...
//                   </li>
//                   <li>
//                     <Link href="/manage-products">🛠️Manage Products</Link>
//                   </li>
//                   <li>
  ...
  return (
    <header className="sticky top-0 z-50 bg-base-100 shadow-md">
      <div className="container mx-auto px-4 py-4">
            ...
            {status === "loading" ? (
              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  ...
                  <li><Link href="/manage-products">🛠️ Manage Products</Link></li>
                  <li>
                    <button
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 flex flex-col space-y-2">
            <Link href="/" className="block px-4 py-2 hover:bg-base-200 rounded"
              onClick={() => setIsMenuOpen(false)}>Home</Link>
            <Link href="/products" className="block px-4 py-2 hover:bg-base-200 rounded"
              onClick={() => setIsMenuOpen(false)}>Products</Link>
            <Link href="/about" className="block px-4 py-2 hover:bg-base-200 rounded"
              onClick={() => setIsMenuOpen(false)}>About</Link>
            <Link href="/contact" className="block px-4 py-2 hover:bg-base-200 rounded"
              onClick={() => setIsMenuOpen(false)}>Contact</Link>

            {session ? (
              <>
                <Link href="/add-product" className="block px-4 py-2 hover:bg-base-200 rounded"
                  onClick={() => setIsMenuOpen(false)}>Add Product</Link>
                <Link href="/manage-products" className="block px-4 py-2 hover:bg-base-200 rounded"
                  onClick={() => setIsMenuOpen(false)}>Manage Products</Link>
                <button
                  onClick={() => {
                    signOut({ redirect: true, callbackUrl: "/" });
                    setIsMenuOpen(false);
              ...
              <>
                <Link href="/login" className="block px-4 py-2 btn btn-outline"
                  onClick={() => setIsMenuOpen(false)}>Login</Link>
                <Link href="/register" className="block px-4 py-2 btn btn-primary"
